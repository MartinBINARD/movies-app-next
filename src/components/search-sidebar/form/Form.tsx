...
export const Form = () => {
  ...
  return (
    ...
    >
      <h2 className="text-black text-base px-4 py-3 m-0 border-b-2 border-gray-200">
        Filtrer
      </h2>
      ...
      <div className="border-b-2 border-gray-200 pt-0 px-4 pb-2">
        ...
        <div className="flex items-center justify-between mt-4 ">
          ...
          <input
            type="date"
            name="formDate"
            className="rounded-md border border-gray-200 p-2 min-w-[200px]"
          />
        </div>
        <div className="flex items-center justify-between mt-4">
      ...
      <div className="pt-0 px-4 pb-2">
        ...
        <select
          name="sort"
          className="w-full border border-gray-200 py-2 px-1 mb-3"
        >
